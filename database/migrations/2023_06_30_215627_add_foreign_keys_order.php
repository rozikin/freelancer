...
class AddForeignKeysOrder extends Migration
{
    ...
    public function up()
    {
        Schema::table('order', function (Blueprint $table) {
            ...
            $table->foreign('freelancer_id','fk_order_freelancer_to_service')->references('id')->on('users')->onUpdate('CASCADE')->onDelete('CASCADE');
            $table->foreign('service_id','fk_order_to_service')->references('id')->on('users')->onUpdate('CASCADE')->onDelete('CASCADE');
    ...
    public function down()
    {
        Schema::table('order', function (Blueprint $table) {
            ...
            $table->dropForeign('fk_order_freelancer_to_service');
