...
@section('content')
    <section class="w-auto flex min-h-[85vh] pt-6 pb-20 mx-auto lg:mx-12 px-4">
        <div class="h-auto m-auto text-center">
            <svg class="w-full mb-6" width="490" height="350" viewBox="0 0 490 350" fill="none"
            ...
            <h1 class="mb-4 text-3xl font-bold">Successful Booking</h1>
            <p class="mb-6 leading-8 text-serv-text">
                To continue payment, please contact directly <br class="hidden lg:block">
                our Freelancer through WhatsApp
            </p>
            <a href="http://wa.me/628123456789"
                class="inline-block py-4 my-2 font-medium text-center text-white bg-serv-button text-md w-80 rounded-2xl">
                Continue to Chat
            </a>
            <br>
            <a href="{{ route('index') }}"
                class="inline-block py-4 my-2 font-medium text-center bg-serv-services-bg text-serv-bg text-md w-80 rounded-2xl">
                Back to Home
            </a>
