    ...
    <div class="hero">
        <div class="flex flex-col px-8 pt-16 pb-16 mx-auto lg:pb-20 lg:px-24 md:px-16 sm:px-8 lg:flex-row">
            ...
            <div
                ...
                <h1
                    class="mb-5 text-3xl font-semibold text-black-1 lg:leading-normal sm:text-4xl lg:text-5xl lg:mt-20">
                ...
                <div
                    ...
                    <button class="px-12 py-4 my-2 text-lg font-semibold text-white bg-green-500 rounded-lg bg-serv-button" onclick="toggleModal('registerModal')">
                        Get Started
                    </button>
                </div>
            </div>
